...
- PR descriptions carry no "Generated by Claude" line, no tooling footer,
  nothing that names the tooling at all. A PR description is public and
  professional, not a transcript of the session that produced it — write it
  the way any contributor would write one, about the change, for whoever
  reviews it.
